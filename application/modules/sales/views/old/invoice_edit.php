                ...
                <form  action="<?php echo $this->config->item('base_url'); ?>sales/update_invoice" method="post" class=" panel-body">
                    ...
                    <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline invedit_left">
                        ...
                        <td width="25%">
                            ...
                            <span  class="tdhead"> IME Detection :</span>
                            ...
                            <div class="input-group" style="width:65%;">
                                ...
                                <div class="input-group-addon" style="padding: 5px 12px;">
                                    ...
                                    <a href="javascript:" style="border: 0px solid #cbced4 !important;"> <i class="fa fa-barcode" onclick="ime_code_scan()"></i></a>
                                                                                                                                              ...
                                                                                                                                              <!--<input type="text" tabindex="5" class="form-control bar_code_detection " name="bar_code_detection"  style="width:200px; display: inline" id="bar_code_detection" autocomplete="off">-->
                        ...
                        <input type="hidden"  name="pc_id" id="pc_id" class='id_customer form-align tabwid' value="<?php echo $val['id']; ?>" />
                                                                                                                                                                ...
                                                                                                                                                                <!--<tr>
                                                                                                                                                                    ...
                                                                                                                                                                    <td>
                                                                                                                                                                        ...
                                                                                                                                                                        <select tabindex="4" name='quotation[sales_man]' class="form-control class_req required"  style="width:50%">
                    ...
                    <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                        ...
                        <thead>
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td width="8%" class="first_td1 action-btn-align">Sales Price</td>
...
//                                    }
                        ...
                        <td colspan="9" style="text-align:right !important;">Advance Amount</td>
                        ...
                        <td colspan="9" style="text-align:right !important;">Round Off ( - )<br>
                        ...
                        <td colspan="9" style="text-align:right;">Labour Charge</td>
