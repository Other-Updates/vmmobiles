...
<!--                            <input type="radio" class="receiver" id="bill1" value="cash" name="cashbill"/>Cash sale
                    ...
                    <!--<div class="form-group">
                       ...
                       <label class="col-sm-4 control-label">Bar Code Detection <span style="color:#F00; font-style:oblique;">*</span></label>

                       <div class="col-sm-8">

                           <div class="input-group">

<input type="text"  class="form-control form-align " id="bar_code_detection"  name="bar_code_detection" placeholder="Enter Scan ime code" value="">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-4 control-label">IME Detection <span style="color:#F00; font-style:oblique;"></span></label>
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td width="15%" class="first_td1">IME Code</td>
...
<!--                            <td class="action-btn-align">
                    ...
                    <tbody class="addtional">
                        ...
                        <tr>
                            ...
                            <td colspan="9" style="text-align:right;"><b>Advance Amount</b></td>
...
//                                            $(this).closest('tr').find('input.selling_price').val(price);
...

    {
        ...
        $('.qty').each(function () {
            ...
            var sp_with_gst = $(this).closest('tr').find('.sp_with_gst');
            var sp_without_gst = $(this).closest('tr').find('.percost');
...

            {
                ...
                taxless = Number(qty.val()) * Number(sp_with_gst.val());
                ...
                pertax1 = Number(pertax.val() / 100) * Number(sp_with_gst.val());



                gst1 = Number(gst.val() / 100) * Number(sp_with_gst.val());
                ...
                var tot_price = Number(sp_with_gst.val()) - Number(sp_without_gst.val());
                subtotal_val = (Number(qty.val()) * Number(tot_price));
                final_subtotal_val = (Number(qty.val()) * Number(sp_without_gst.val())) + (subtotal_val);
                subtotal.val(Number(qty.val()) * Number(sp_without_gst.val()).toFixed(2));

                final_qty = final_qty + Number(qty.val());

                final_sub_total = final_sub_total + (Number(qty.val()) * Number(sp_without_gst.val()));
