...
<style type="text/css">
    ...
    .words, .goods-condi {display:none; width: 100%; margin-bottom: 20px;}
    .goods-condi .gc1 { border: 1px solid #000; float: left; width: 20%; height: 110px; padding: 10px;}
    .goods-condi .gc2 { border: 1px solid #000; float: left; width: 60%; height: 110px; padding: 10px;}
    .goods-condi .gc3 { border: 1px solid #000; float: left; width: 20%; height: 110px; padding: 10px;}


    @media print{
        .print_header {min-height:110px !important; }
        table tr td {border:1px solid black !important;}
		table tr {border-right:1px solid black !important; }
        body {-webkit-print-color-adjust:exact;}
        .imeview {border-top:1px solid black !important;table tr td {border:1px solid black !important;}}
        table {100% !important; }
        .table-bordered>tfoot>tr>td { border: 1px solid black !important;}
        .words {display:block; margin-top:-21px;}
        .print_bgclr.table>thead:first-child>tr:first-child>td { background-color:#1E9FF2 !important; -webkit-print-color-adjust; }
        .print_bgclr thead td { color: #fff !important; font-weight: bold;}
        .table-bordered>tfoot>tr> {
            border-top:1px solid black !important;
            border-bottom:1px solid black !important;}
        .tfootbotom {margin-top:-5px !important; border:1ps solid black !important;}
        .table>thead>tr>th, .table>tbody>tr>th, .table>tfoot>tr>th, .table>thead>tr>td, .table>tbody>tr>td, .table>tfoot>tr>td {
            padding: 4px 4px 4px 4px !important;
            line-height: 1.928571;font-size: 14px !important;}
        .goods-condi { display:block;}
    }
    @page {
    ...
    .print_bgclr.table thead th { color: #fff !important;}
    .print_header_tit {
        width: 100%;
    ...
    <table width="100%" style="background-color:#1E9FF2;">
        ...
        <tr>
            ...
            <td width="50%" style="vertical-align:middle;">
                ...
                <div class="print_header_logo"style="width:350px !important;" ><img src="<?= $theme_path; ?>/images/logo3.png" width="400px"/></div>
            ...
            foreach ($quotation as $val) {
                ...
                <table class="table ptable" cellpadding="0" cellspacing="0" style="margin-top:-5px;">
                    ...
                    <tr>
                        ...
                        <td width="25%" align="center; vertical-align:middle;"><h1 >CASH&nbsp;BILL</h1></td>

                        <td width="30%" align="left" style="vertical-align:middle;">Invoice No : <?php echo '' . $val['inv_id']; ?><br /> <!--Reference No :  <?php echo $val['q_no']; ?>--><br /><br/> Date : <?php echo ($val['created_date'] != '1970-01-01') ? date('d-M-Y', strtotime($val['created_date'])) : ''; ?><br /><!--Sales Man : <?php
                    ...
                    <thead style="color:white !important;">
                        ...
                        <tr style="text-align:center; color:white !important;">
                            ...
                            <td width="7%" class="first_td1 action-btn-align ser-wid">QTY</td>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <!--<td width="%" class="first_td1 action-btn-align ser-wid">Sales Price</td>-->
                            ...
                            <td width="15%" class="first_td1 action-btn-align qty-wid">Amount</td>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           <!-- <td width="5%" class="first_td1 action-btn-align proimg-wid hide_class">IME View</td>-->
...
//                                $net_total = $net_total;
                                    ...
                                    <td class="text_right" style="text-align:right;">
                                        ...
                                        ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <!-- <td class="hide_class  action-btn-align hide_class">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <!--<tr class="imeview">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <td colspan="2"><b>Ime code</b></td>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <td class="imeview" colspan="9">
                                <?php
                                if (!empty($vals['ime_code_details'])) {

                                    foreach ($vals['ime_code_details'] as $key => $ime_data) {
                                        ?>

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         <input type="text"value="<?php echo $ime_data['ime_code']; ?>" readonly maxlength="15" style="width:130px;">
                    ...
                    <tfoot>
                        ...
                        <?php
                        $gst = number_format(($sgst + $cgst), 2)
                        ?>
                        <tr><td align="right" colspan="4">GST</td>
                ...
                <table width="100%" class="tfootbotom table table-bordered m-b-0">
                    ...
                    <tr style="border-bottom:1px solid black; background: #f4f8fb;">
                        ...
                        <td width="10%" class="text_right bor-tb0"><?php echo number_format($cgst, 2); ?></td>
                        <?php
                        $gst_type = $quotation[0]['state_id'];
                        //  if ($gst_type != '') {
                        if ($gst_type == 31) {
                        ...
                        // }
                        ?>
                        <td width="10%" class="text_right bor-tb0" ><?php echo number_format($sgst, 2); ?></td>


                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <!--<td width="10%" class="text_right bor-tb0" ><?php echo number_format($val['round_off'], 2); ?></td>-->
