        ...
        <input type="hidden" id="sale_cat_type" name="sale_cat_type" value="<?php echo $category[0]['cat_id'];?>" />
            ...
            <div class="row" id="add_sales">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" name="quotation[delivery_status]" value="delivered" id="delivery_status" tabindex="-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name='quotation[sales_man]' tabindex="3" class="form-control class_req" id="sales_man">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" name="customer[tin]" id="tin" tabindex="4" class="form-control form-align " />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="radio" tabindex="5" class="receiver" id="bill1" value="cash" name="quotation[bill_type]" checked /> &nbsp;Cash Sale

                            <input type="radio" tabindex="5" class="receiver" id="bill2" value="credit" style="margin-left:25px;" name="quotation[bill_type]" /> &nbsp;Credit Sale<br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" tabindex="6" class="form-control form-align datepicker required" name="quotation[created_date]" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" tabindex="7" name="bar_code_detection" maxlength="15" class="bar_code_detection  form-align" id="bar_code_detection" autocomplete="off">
                ...
                <table class="table  table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    ...
                    <tbody id='app_table'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" tabindex="9" name="model_no[]" id="model_no" style="width:100%; font-weight: 600;" class='form-align auto_customer tabwid model_no required' readonly="" />
                            ...
                            <td class="action-btn-align">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <input type="text" tabindex="11" name='quantity[]' style="width:70px;" class="qty required quantity" data-stock="0"/>
                            ...
                            <td class="action-btn-align">
                                ...
                                <input type="text" tabindex="12" name='per_cost[]' style="width:70px;" class="selling_price percost required" />
                                <input type="hidden" name="sp_with_gst[]" class="sp_with_gst">
                                <input type="hidden" name="sp_without_gst[]" class="sp_without_gst">
                            ...
                            <td class="action-btn-align">
                                ...
                                <input type="text" tabindex="13" style="width:75px;" class="hsn_code" readonly="readonly" autocomplete="off" />
                            ...
                            <td class="action-btn-align cgst_td">
                                ...
                                <input type="text" name='tax[]' tabindex="14" style="width:70px;" class="pertax" readonly="readonly" />

                            </td>

                            <td class="action-btn-align sgst_td">

                                <input type="text" name='gst[]' tabindex="15" style="width:70px;" class="gst" readonly="readonly" />

                            </td>

                            <td class="action-btn-align igst_td">

                                <input type="text" name='igst[]' tabindex="-1" style="width:70px;" class="igst wid50" readonly="readonly" />

                            </td>

                            <td>

                                <input type="text" style="width:100px;" tabindex="16" name='sub_total[]' readonly="readonly" class="subtotal text_right" />
                    ...
                    <tbody class="addtional">
                        ...
                        <tr>
                            ...
                            <td class="action-btn-align"><input type="text" tabindex="18" name="quotation[total_qty]" readonly="readonly" class="total_qty" style="width:70%;" id="total" /></td>

                            <td colspan="4" style="text-align:right;"><b>Sub Total</b></td>

                            <td class="action-btn-align"><input type="text" name="quotation[subtotal_qty]" tabindex="19" readonly="readonly" class="final_sub_total text_right" style="width:100px;" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;"><input type="text" tabindex="20" name="quotation[tax_label]" class='tax_label text_right' style="width:100%;" /></td>

                            <td>

                                <input type="text" name="quotation[tax]" class='totaltax text_right' tabindex="21" style="width:100px;" />
                    ...
                    <tbody class="additional" id="add_new_values">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="quotation[taxable_price]" value="" readonly class="taxable_price text_right" tabindex="22" style="width:70px;" /></td>

                            <td style="text-align:right;"> CGST </td>

                            <td><input type="text" tabindex="23" value="" name="quotation[cgst_price]" readonly class="add_cgst text_right cgst_price" style="width:100px;" /></td>

                            <td style="text-align:right;" class="sgst_td"> SGST </td>

                            <td style="text-align:right;" class="igst_td"> IGST </td>

                            <td><input type="text" tabindex="24" value="" name="quotation[sgst_price]" readonly class="add_sgst text_right sgst_price" style="width:70px;" /></td>
                            ...
                            <td><input type="text" tabindex="25" name="quotation[net_total]" id="net_total" readonly="readonly" class="final_amt text_right" style="width:100px;" /></td>
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                <input name="quotation[remarks]" tabindex="26" type="text" class="form-control" style="width:90%; display: inline" />
            ...
            <div>
                ...
                <input type="text" tabindex="27" class="form-control class_req borderra0 terms" name="quotation[mode_of_payment]" />
            ...
            <div class="action-btn-align mb-bot20">
                ...
                <button class="btn btn-primary" name="print" value="yes" id="save_print"><span class="glyphicon glyphicon-plus"></span> Save and <span class="glyphicon glyphicon-print"></span> print</button>
