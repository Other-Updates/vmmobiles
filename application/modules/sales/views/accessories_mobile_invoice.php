            ...
            <tr>
                ...
                <td class="qty_text">
                    ...
                    <div class="col-xs-8">
                        ...
                        <input type="text" tabindex="2" name='quantity[]' style="width:70px;" class="qty quantity" value="" id="qty" data-stock="0"/>
...
<div id="test1" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
        ...
        <form method="post" class="panel-body" id="quotation">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" tabindex="5" name="customer[tin]" id="tin" tabindex="-1" class="form-control form-align " />
                ...
                <table class="table  table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    ...
                    <tbody id='app_table'>
                        ...
                        <tr>
                            ...
                            <td class="action-btn-align igst_td">
                                ...
                                <input type="text" name='igst[]' tabindex="16" style="width:70px;" class="igst wid50" readonly="readonly" />

                            </td>

                            <td>

                                <input type="text" style="width:100px;" tabindex="17" name='sub_total[]' readonly="readonly" class="subtotal text_right" />
                    ...
                    <tbody class="addtional">
                        ...
                        <tr>
                            ...
                            <td class="action-btn-align"><input type="text" tabindex="19" name="quotation[total_qty]" readonly="readonly" class="total_qty" style="width:70%;" id="total" /></td>

                            <td colspan="4" style="text-align:right;"><b>Sub Total</b></td>

                            <td class="action-btn-align"><input type="text" name="quotation[subtotal_qty]" tabindex="20" readonly="readonly" class="final_sub_total text_right" style="width:100px;" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;"><input type="text" tabindex="21" name="quotation[tax_label]" class='tax_label text_right' style="width:100%;" /></td>

                            <td>

                                <input type="text" name="quotation[tax]" class='totaltax text_right' tabindex="22" style="width:100px;" />
                    ...
                    <tbody class="additional" id="add_new_values">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="quotation[taxable_price]" value="" readonly class="taxable_price text_right" tabindex="23" style="width:70px;" /></td>

                            <td style="text-align:right;"> CGST </td>

                            <td><input type="text" tabindex="24" value="" name="quotation[cgst_price]" readonly class="add_cgst text_right cgst_price" style="width:100px;" /></td>

                            <td style="text-align:right;" class="sgst_td"> SGST </td>

                            <td style="text-align:right;" class="igst_td"> IGST </td>

                            <td><input type="text" tabindex="25" value="" name="quotation[sgst_price]" readonly class="add_sgst text_right sgst_price" style="width:70px;" /></td>
                            ...
                            <td><input type="text" tabindex="26" name="quotation[net_total]" id="net_total" readonly="readonly" class="final_amt text_right" style="width:100px;" /></td>
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                <input name="quotation[remarks]" tabindex="27" type="text" class="form-control" style="width:90%; display: inline" />
            ...
            <div>
                ...
                <input type="text" tabindex="28" class="form-control class_req borderra0 terms" name="quotation[mode_of_payment]" />
