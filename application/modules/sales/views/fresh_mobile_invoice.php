    ...
    <div class="contentpanel mb-45">
        ...
        <table class="static" style="display: none;">
            ...
            <tr>
				...
				<a id='delete_group' class="btn btn-danger delete_group">
                        ...
                        <tr>
                            ...
                            <td class="action-btn-align">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <input type="text" name='quantity[]' style="width:70px;" class="qty required quantity" data-stock="0"/>
