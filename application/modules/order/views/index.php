...
<div class="mainpanel">
            ...
            <form  method="post">
                <table style="width:50%;margin:0 auto;" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                    <tr>
                        ...
                        <td> <input type="text"  tabindex="-1" name="quotation[q_no]" style="width:170px;" class="code form-control colournamedup" readonly="readonly" value="<?php echo $last_id[0]['value'];?>"  id="grn_no"></td>
                        <td>Customer Name</td>
                        <td>
                            <input type="text"  name="customer[name]" id="customer_name" class='auto_customer' />
                             <input type="hidden"  name="customer[id]" id="customer_id" class='id_customer' />
                   ...
                   <tr>
                        ...
                        <td>
                            <input type="text"  name="customer[mobil_number]" id="customer_no" />
                        </td>
                       <td class="first_td1"  >Customer Email ID</td>
                        <td id='customer_td'>
                            <input type="text"  name="customer[email_id]" id="email_id"/>
                        </td>              
                   </tr>
                   <tr>
                        <td class="first_td1">Customer Address</td>
                        <td>
                            <textarea name="customer[address1]" id="address1"></textarea>
                        </td>                                 
                   </tr>               
                </table>
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                	<tr>
                        ...
                        <td width="5%" class="action-btn-align"><a id='add_group' class="btn btn-defaultadd3 form-control"><span class="glyphicon glyphicon-plus"></span> Add Row</a>
                       </td>
                    </tr>
                    <tbody id='app_table'>
                        <tr>
                    ...
                    <tfoot>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td colspan="8" style="">
                            	<span style="float:left; position:relative; top:12px;">Remarks&nbsp;&nbsp;&nbsp;</span> 
                                <input name="quotation[remarks]"  style="float:left;width:90%;" type="text" class="form-control"  />
                            </td>
                        </tr>
                    </tfoot>
                </table>
                        	...
                        	<table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control datepicker class_req" name="quotation[delivery_schedule]" placeholder="dd-mm-yyyy" >
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <div class="input-group" style="width:70%;">
                                        <input type="text"  id='to_date' class="form-control datepicker" name="quotation[notification_date]" placeholder="dd-mm-yyyy" >                                  
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td></td>
                                    <td><input type="text" style="width:261px;" class="form-control class_req" name="quotation[mode_of_payment]"/></td>
                                </tr>
                                   <input type="hidden"  name="quotation[customer]" id="customer_id" class='id_customer' />
                ...
                <div class="action-btn-align">
                  <button class="btn btn-primary btn-rounded"><span class="glyphicon glyphicon-plus"></span> Create</button>
                    </div>
                <br />
                </form>
            </div><!-- contentpanel -->
    ...
    $(".id_customer").val(id);
           $.ajax({
                url:"<?php echo $this->config->item('base_url');?>" + "quotation/get_customer_by_id",
                type:'post',
                data:{id:id},
                success:function(data){                 
            ...
            function calculate_function()
                {
                    ...
                    $('.qty').each(function(){
                        ...
                        if(Number(qty.val())!=0)
                        {
                            sub_total=( Number(qty.val()) * Number(percost.val()) ) + Number(pertax.val());
