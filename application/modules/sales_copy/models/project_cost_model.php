...
//            echo $this->db->last_query();
    ...
    public function get_products_by_barcode($bar_code) {
    ...
    function _get_datatables_query1() {
        ...
        $this->db->select('i.net_total As inv_amount,i.inv_id,i.invoice_status,i.payment_status,i.delivery_status,i.contract_customer,i.customer,i.created_date,c.store_name,q.id,q.q_no,q.net_total,i.id As i_id,i.delivery_qty,f.firm_name as shop_name');
