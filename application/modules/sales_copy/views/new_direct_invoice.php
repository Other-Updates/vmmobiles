...
<!--                <td>
        ...
        <div id="test1" class="modal fade in" tabindex="-1"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="brand form-control form-group mandatory customername borderra0 form-align " data-num="1" name="customer_name"

                                                   value="" id="customername" maxlength="40" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" class="brand form-control  mandatory   borderra0 form-align " data-num="4" name="mobile_num"

                                                   value="" id="mobile_num" maxlength="40" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group form-group" style="width: 100%;">
                                            ...
                                            <input type="text" class="address form-control  mandatory  borderra0 form-align " data-num="5" name="address"

                                                   value="" id="address" maxlength="40" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="customer_gstin form-control  form-group  mandatory borderra0 form-align emailid" data-num="6" name="customer_gstin" value="" id="customer_gstin" maxlength="40" />
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" name="customer[tin]" id="tin" tabindex="-1"   class="form-control form-align "/>
...
<!--                            <input type="radio" class="receiver" id="bill1" value="cash" name="cashbill"/>Cash sale
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-4 control-label">IMIE Detection <span style="color:#F00; font-style:oblique;"></span></label>
                ...
                <table class="table  table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td width="15%" class="first_td1">IMIE Code</td>
                    ...
                    <td class="action-btn-align">
                        ...
                        <div class="col-xs-8">
                            ...
                            <input type="text" name='quantity[]' style="width:70px;" class="qty required quantity" data-stock="0"  readonly/>
                    ...
                    <td class="action-btn-align cgst_td">
                        ...
                        <input type="text"  name='tax[]' tabindex="-1" style="width:70px;" class="pertax" readonly="readonly"/>

                    </td>

                    <td class="action-btn-align sgst_td">

                        <input type="text"  name='gst[]' tabindex="-1" style="width:70px;" class="gst" readonly="readonly"/>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align:right;font-weight:bold;"><input type="text" tabindex="-1" name="quotation[tax_label]" class='tax_label text_right' style="width:100%;" /></td>
                    ...
                    <td><input type="text" name="quotation[taxable_price]" value="" readonly class="taxable_price text_right" tabindex="-1" style="width:70px;" /></td>

                    <td style="text-align:right;"> CGST </td>

                    <td><input type="text" tabindex="-1"  value=""  name="quotation[cgst_price]"  readonly class="add_cgst text_right cgst_price" style="width:100px;" /></td>

                    <td style="text-align:right;" class="sgst_td"> SGST </td>

                    <td style="text-align:right;" class="igst_td"> IGST </td>

                    <td><input type="text" tabindex="-1" value=""  name="quotation[sgst_price]" readonly class="add_sgst text_right sgst_price" style="width:70px;" /></td>
                                            ...
                                            if (firm_id) {
                                                ...
                                                $('.mandatory').each(function (i) {
                                                    ...
                                                    if (num == 2 && this_val.length > 1) {
                                                        ...
                                                        if (mail != "" && !efilter.test(mail)) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                type: 'get',
                                                                data: {email: mail, firm_id: firm_id},
                                                    ...
                                                    if (num == 4 && this_val.length > 1) {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            type: 'get',
                                                            data: {number: this_val, firm_id: firm_id},
                                                            success: function (result)
                                                ...
                                                if (m > 0) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        type: 'post',
                                                        data: {firm_id: firm_id, cus_name: cus_name, cus_email: cus_email, cus_type: cus_type, cus_num: cus_num, cus_address: cus_address, customer_gstin: customer_gstin},
                                                        success: function (result)

                                                        {
                                                            ...
                                                            $.ajax({
                                                                type: 'POST',
                                                                data: {cust_id: result, firm_id: firm_id},
            ...
            if (this_val == "") {
                ...
                if (this_id == "ime_code_vals") {
                    ...
                    if (this_class != undefined) {
                        ...
                        $(this).closest('tr td').find('.error_msg').text('Please add IMIE code').css('display', 'inline-block');

                        $(this).closest('div .form-group').find('.error_msg').text('Please add IMIE code').css('display', 'inline-block');
...
//                                            $(this).closest('tr').find('input.selling_price').val(price);
    ...
    function calculate_function()
    {
        ...
        var final_sub_total = final_sub_total + Number(totaltax);

        var taxable_price = final_sub_total - Number(total_gst_price).toFixed(2) + totaltax;
...
//                            this_val.closest('tr').find('.qty').trigger('keyup');
    ...
    $('.ime_code_id').live('change', function () {
    ...
    function set_ime_code_from_pro_id(product_id, pro_qty, class_name) {
        ...
        if (hidden_push_val != 0) {
            ...
            $.ajax({
                type: 'POST',
                data: {product_id: product_id, pro_qty: ime_qty, ime_code: ime_val},
                async: false,
