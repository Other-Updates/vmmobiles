                ...
                <form  action="<?php echo $this->config->item('base_url'); ?>sales/update_invoice" method="post" class=" panel-body">
                    ...
                    <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline invedit_left">
                        ...
                        <td width="25%">
                            ...
                            <span  class="tdhead"> IMIE Detection :</span>
...
//                                    }
                                ...
                                <td>
                                    ...
                                    <input maxlength="8" type="text" tabindex="-1"  name='tax[]' style="width:70px;" class="pertax" value="<?php echo number_format($vals['tax'], 2); ?>" />
                                ...
                                if ($gst_type == 31) {
                                    ...
                                    <td>
                                        ...
                                        <input maxlength="8" type="text" tabindex="-1" name='gst[]' style="width:70px;" class="gst" value="<?php echo number_format($vals['gst'], 2); ?>" />
                                ...
                                <?php } else { ?>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name='igst[]' tabindex="-1" style="width:70px;" class="igst" value="<?php echo number_format($vals['igst'], 2); ?>" />
                        ...
                        <td><input type="text" tabindex="-1" name="quotation[taxable_price]"  value="<?php echo $quotation[0]['taxable_price']; ?>"  class=" text_right taxable_price" style="width:70px;" /></td>
