...
<div class="mainpanel">
    ...
    <div class="contentpanel mb-25">
        <div class="media">
            <h4>Update Fresh Purchase Request</h4>
        </div>
        <table class="static" style="display: none;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id='cat_id' readonly tabindex="-1" class='form-align cat_id static_style class_req form-control' style="width:100%" name='categoty[]'>
                ...
                <td class="ime_modal">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" tabindex="-1" name='quantity[]' style="width:50px;" class="qty  form-control" value="0" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" tabindex="2" class="form-align datepicker required" name="po[created_date]" placeholder="dd-mm-yyyy" id="form_date" value="<?= date('d-m-Y', strtotime($val['created_date'])); ?>" onblur="validate_date('form_date')">
                        ...
                        <table class="table  table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                            ...
                            <tbody id='app_table'>
                                ...
                                ?>
                                        <tr class="" data-inc="">
                                            ...
                                            <td>
                                                <select id='cat_id' readonly class='form-control cat_id static_style class_req required' name='categoty[]' style="width:100%">
                                                    <option value="">Select</option>
                                                    <?php
                                                    if (isset($category) && !empty($category)) {
                                                    ...
                                                    ?>
                                                            <option value='<?php echo $va['cat_id'] ?>' <?php echo $select; ?> <?php echo ($va['categoryName'] == 'Fresh Mobiles') ? 'selected' : '';?>><?php echo $va['categoryName'] ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <td>
                                                <input type="text" name="model_no[]" id="model_no" style="width:100%" class='form-control form-align auto_customer tabwid model_no required' tabindex="3" value="<?php echo $vals['product_name']; ?>" />
                                                <span class="error_msg"></span>
                                            ...
                                            <td class="ime_modal">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" tabindex="4" name='quantity[]' style="width:50px;" class="qty  form-control" value="<?php echo $vals['quantity']; ?>" />
                                                </div>
                                        ...
                                        <input type="text"   tabindex="1"  style="width:70px;" class="gross"   />
                                            ...
                                            <td class="action-btn-align">
                                                ...
                                                <input type="text" tabindex="-1" style="width:75px;" class="hsn_code" readonly="readonly" autocomplete="off" value="<?php echo $vals['hsn_sac']; ?>" />
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><input type="text" name="po[subtotal_qty]" tabindex="5" readonly="readonly" value="<?php echo $val['subtotal_qty']; ?>" class="final_sub_total text_right" style="width:70px;" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" tabindex="6" name="po[net_total]" readonly="readonly" class="final_amt text_right" style="width:70px;" value="<?php echo $val['net_total']; ?>" /></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="14" style="">
                                        ...
                                        <input name="po[remarks]" type="text" tabindex="7" class="form-control remark" value="<?php echo $val['remarks']; ?>" />
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    function ime_modal(id) {
        ...
        if (ime_qty > 0 && product_name != "") {
            ...
            html += '<div class="form-group">' + '<div class="ime_code_loop"><div class="row col-md-12">' +
                ...
                '<input type="text" class=" form-control ime_code_width ime_code_detect" tabindex="1" name="ime_code_detect" value="" id="ime_code_detect" maxlength="15" autocomplete="off"><div class="input-group-addon"><a href="javascript:" tabindex="-1"> <i class="fa fa-barcode" onclick="bar_code_detection(' + id + "," + ime_qty + ')"></i></a></div>' +
                '</div></div></div></div></div>';
            ...
            html += '</div>' +
                ...
                ' <button type="button" class="edit btn btn-info1 update_ime" tabindex="-1" onclick="ime_modal_update(' + id + "," + ime_qty + ')">Update</button>' +
