...
//                            }
                    ...
                    ?>
                           ...
                           <select name="po[pr_status]" tabindex="-1" class="form-control required form-align" id="pr_status"   >
                        ...
                        // foreach ($pr_status as $status)
                        {
                            ?>
                                                                                                                                                               ...
                                                                                                                                                               <!-- <option value="<?php echo $status; ?>"> <?php echo ucwords(str_replace("_", " ", $status)); ?> </option>
                                                                                                                                                                ...
                                                                                                                                                                <option value="approved"> <?php echo ucwords(str_replace("_", " ", "Approved")); ?> </option>
            ...
            <div class="mscroll">
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                    ...
                    <td class="ime_modal">
                        ...
                        <div class="col-md-2">
                            <a class="btn btn-info btn-xs ime_modal_add" id="ime_code_add" style="margin-top:6px; margin-left:-5px;" title="Add Ime Code" onclick="ime_modal(0)">
                                <span class="fa fa-barcode"></span>
                            </a>
                   ...
                   <!-- <td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td><div class="col-md-5"><b>Total</b></div><div class="col-md-5"><input type="text" tabindex="-1"  name="po[total_qty]"   readonly="readonly" class="total_qty" style="width:50px;" id="total" /></div></td>
...
//alert(datas);
                                        ...
                                        if (pr_id != '') {
                                            $.ajax(
                                                    {
                                                        url: BASE_URL + "purchase_order/check_duplicate_pr_idss",
                                                        type: 'POST',
                                                        data: {value1: pr_id},
