        ...
        <table class="static" style="display: none;">
           ...
           <!-- <td class="action-btn-align">
            ...
            <td class="ime_modal">
                ...
                <div class="col-md-2">
                    <a class="btn btn-info btn-xs ime_modal_add" style="margin-top:6px; margin-left:-5px;border-radius:0px;" title="Add IMIE Code">
                                    ...
                                    <div class="modal-dialog ">
                                        <div class="modal-content modalcontent-top">
                                            <div class="modal-header modal-padding modalcolor">
                                                ...
                                                <h3 id="myModalLabel" style="color:white;margin-top:10px">IMIE Code Update  </h3>
                                            </div>
                            ...
                            <tbody id='app_table'>
                                ...
                                if (isset($po_details) && !empty($po_details)) {
                                    ...
                                    <td class="ime_modal">
                                        ...
                                        <div class="col-md-2">
                                            <a class="btn btn-info btn-xs ime_modal_add" id="ime_code_add" style="margin-top:6px; margin-left:-5px; border-radius: 0px;" title="Add IMIE Code" onclick="">
                                                <span class="fa fa-barcode"></span>
                                            </a>
...
<script type="text/javascript">
                                    ...
                                    function bar_code_detection(id, pro_qty) {
                                        ...
                                        for (i = 1; i <= pro_qty; i++) {
                                            ...
                                            if (ime_val == string) {
                                                var data = "Duplicate Records in IMIE Code " + i + '';
                                        ...
                                        if (string == "") {
                                            toastr.clear();
                                            toastr.error("IMIE Code Required", 'Warning Message.!');
                                        } else if (!($.isNumeric(string))) {
                                            toastr.clear();
                                            toastr.error("IMIE Code Allowed Only Numbers", 'Warning Message.!');
                                            ...
                                            for (i = 1; i <= pro_qty; i++) {
                                                ...
                                                if (id_val == "") {
                                                    if (check_data == "") {
                                                        ...
                                                        if (i == pro_qty) {
                                                            toastr.warning("IMIE Code Detected..Please Update Code", 'Warning Message.!');
                                            ...
                                            toastr.clear();
                                            toastr.error("Invalid IMIE Code..Allowed Only 15 Numeric", 'Warning Message.!');
                                        }
...
//product_name="test";
                                        ...
                                        if (ime_qty > 0 && product_name != "") {
                                            ...
                                            html += '<div id="ime_code_modal' + id + '" class="modal fade in" data-backdrop="false" tabindex="-1" class="ime_code_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"' +
                                                    ...
                                                    '<h3 id="myModalLabel" style="color:white;margin-top:10px">' + product_name + ' - IMIE Code Update</h3>' +
                                                    ' </div>' +
                                                    '<div class="modal-body modal_scroll">' +
                                                    '<form>' +
                                                    '<div class="row">';
                                            ...
                                            for (i = 1; i <= ime_qty; i++) {
                                                ...
                                                html += '<div class="ime_code_loop"><div class="row col-md-12">' +
                                                        '<div class="col-md-6">' +
                                                        '<h5><strong>IMIE Code ' + i + '</strong></h5>' +
                                                        '</div>' +
                                    ...
                                    function ime_modal_update(id, qty) {
                                        ...
                                        for (i = 1; i <= qty; i++) {
                                            ...
                                            if (ime_val == "") {
                                                var data = "Empty Field in IMIE Code " + i + '';
                                                results.push("<p>" + data + "</p>");

                                            } else if (!($.isNumeric(ime_val))) {
                                                var data = "Invalid Records in IMIE Code " + i + '';
                                                results.push("<p>" + data + "</p>");
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    if (data == 0) {
                                                        ...
                                                        toastr.success('IMIE Code Successfully updated', 'Success Message.!');
                                                        ...
                                                        $.each(data, function (key, value) {
                                                            var dup_data = "IMIE Code " + value + '';
                                                            results.push("<p>" + dup_data + "</p>");
                                                        });
                                                        toastr.error(results, 'Alreday Exists IMIE Code.!');
                                                    }
