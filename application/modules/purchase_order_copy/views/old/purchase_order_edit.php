        ...
        <table class="static" style="display: none;">
           ...
           <!-- <td class="action-btn-align">
            ...
            <td class="ime_modal">
                ...
                <div class="col-md-2">
                    <a class="btn btn-info btn-xs ime_modal_add" style="margin-top:6px; margin-left:-5px;border-radius:0px;" title="Add Ime Code">
                ...
                <form  method="post" class="panel-body" id="po_edit_form">
                    ...
                    <div class="mscroll">
                        ...
                        <div id="modal_dynamic" style="display:none">
                            ...
                            <div class="modal_div">
                                <div id="" class="modal fade in ime_code_modal_id " tabindex="-1"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"
                                    ...
                                    <div class="modal-dialog ">
                                        <div class="modal-content modalcontent-top">
                                            <div class="modal-header modal-padding modalcolor">
                                                ...
                                                <h3 id="myModalLabel" style="color:white;margin-top:10px">IME Code Update  </h3>
                                            </div>
                        ...
                        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                            ...
                            <tbody id='app_table'>
                                ...
                                if (isset($po_details) && !empty($po_details)) {
                                    ...
                                    <td class="ime_modal">
                                        ...
                                        <div class="col-md-2">
                                            <a class="btn btn-info btn-xs ime_modal_add" id="ime_code_add" style="margin-top:6px; margin-left:-5px; border-radius: 0px;" title="Add Ime Code" onclick="">
                                                <span class="fa fa-barcode"></span>
                                            </a>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><div class="col-md-5"><b>Total</b></div><div class="col-md-5"><input type="text" tabindex="-1"  name="po[total_qty]"   readonly="readonly" class="total_qty" style="width:50px;" id="total" value="<?php echo $val['total_qty']; ?>"/></div></td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/scannerdetection/1.2.0/jquery.scannerdetection.compatibility.js"></script>
...
<script type="text/javascript">
                                            ...
                                            if (this_val == "") {
                                                ...
                                                if (this_id == "ime_code_value") {
                                                    ...
                                                    if (this_class != undefined) {
                                                        $(this).closest('tr td').find('.error_msg').text('Please add ime code').css('display', 'inline-block');
                                                        $(this).closest('div .form-group').find('.error_msg').text('Please add ime code').css('display', 'inline-block');
                                                        m++;
                                                    } else {
                                            ...
                                            $.ajax(
                                                    {
                                                        ...
                                                        type: 'post',
                                                        data: {value1: pr_id, value2: erp_po_id},
                                    ...
                                    function bar_code_detection(id, pro_qty) {
                                        ...
                                        if (string == "") {
                                            toastr.clear();
                                            toastr.error("IME Code Required", 'Warning Message.!');
                                        } else if (!($.isNumeric(string))) {
                                            toastr.clear();
                                            toastr.error("IME Code Allowed Only Numbers", 'Warning Message.!');
                                            ...
                                            for (i = 1; i <= pro_qty; i++) {
                                                ...
                                                if (id_val == "") {
                                                    if (check_data == "") {
                                                        ...
                                                        if (i == pro_qty) {
                                                            toastr.warning("IME Code Detected..Please Update Code", 'Warning Message.!');
                                            ...
                                            toastr.clear();
                                            toastr.error("Invalid IME Code..Allowed Only 15 Numeric", 'Warning Message.!');
                                        }
...
//product_name="test";
                                        ...
                                        if (ime_qty > 0 && product_name != "") {
                                            ...
                                            html += '<div id="ime_code_modal' + id + '" class="modal fade in" data-backdrop="false" tabindex="-1" class="ime_code_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"' +
                                                    ...
                                                    '<h3 id="myModalLabel" style="color:white;margin-top:10px">' + product_name + ' - IME Code Update</h3>' +
                                                    ' </div>' +
                                                    '<div class="modal-body modal_scroll">' +
                                                    '<form>' +
                                                    '<div class="row">';
                                            ...
                                            for (i = 1; i <= ime_qty; i++) {
                                                ...
                                                html += '<div class="ime_code_loop"><div class="row col-md-12">' +
                                                        '<div class="col-md-6">' +
                                                        '<h5><strong>IME Code ' + i + '</strong></h5>' +
                                                        '</div>' +
                                    ...
                                    function ime_modal_update(id, qty) {
                                        ...
                                        for (i = 1; i <= qty; i++) {
                                            ...
                                            if (ime_val == "") {
                                                var data = "Empty Field in IME Code " + i + '';
                                                results.push("<p>" + data + "</p>");

                                            } else if (!($.isNumeric(ime_val))) {
                                                var data = "Invalid Records in IME Code " + i + '';
                                                results.push("<p>" + data + "</p>");
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    if (data == 0) {
                                                        ...
                                                        toastr.success('IME Code Successfully updated', 'Success Message.!');
                                                        ...
                                                        $.each(data, function (key, value) {
                                                            var dup_data = "IME Code " + value + '';
                                                            results.push("<p>" + dup_data + "</p>");
                                                        });
                                                        toastr.error(results, 'Alreday Exists IME Code.!');
                                                    }
                                    ...
                                    $('.percost,.pertax,.totaltax,.gst,.igst,.discount,.transport').live('keyup', function () {
                                    ...
                                    function calculate_function()
                                    {
                                        ...
                                        $('.qty').each(function () {
                                            ...
                                            if (Number(qty.val()) != 0)
                                            {
                                                ...
                                                // cost price with gst - new updates

                                                var total_gst_per = Number(pertax.val()) + Number(gst.val()) + Number(igst.val());
                                                var price_with_gst = $(this).closest('tr').find('.price_with_gst');
                                                var price_without_gst = $(this).closest('tr').find('.percost');

                                                var total_gst_amt = Number(price_without_gst.val()) * (total_gst_per / 100);
                                                //console.log(total_gst_amt);
                                                //var tot_price = Number(price_with_gst.val()) - Number(price_without_gst.val());
                                                var total_gst = Number(price_with_gst.val()) * (total_gst_per / 100);
                                                subtotal_val = (Number(qty.val()) * Number(total_gst));
                                                final_subtotal_val = (Number(qty.val()) * Number(price_without_gst.val())) + (subtotal_val);
                                                subtotal.val(final_subtotal_val.toFixed(2));

                                                final_qty = final_qty + Number(qty.val());

                                                final_sub_total = final_sub_total + final_subtotal_val;
                                            }
                                        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result != null && result.length > 0) {
                            ...
                            this_val.closest('tr').find('.cost_price').val(result[0].cost_price_without_gst);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result != null && result.length > 0) {
                            ...
                            this_val.closest('tr').find('.discount').val(result[0].discount);
                            this_val.closest('tr').find('.cost_price').val(result[0].cost_price_without);
                            this_val.closest('tr').find('.price_with_gst').val(result[0].cost_price);
                            this_val.closest('tr').find('.type').val(result[0].type);
                            this_val.closest('tr').find('.product_id').val(result[0].id);
                            this_val.closest('tr').find('.product_name').val(result[0].product_name);
