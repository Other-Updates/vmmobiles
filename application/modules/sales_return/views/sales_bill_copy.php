...
<div class="mainpanel">
    ...
    <div class="contentpanel enquiryview ptpb-10 viewquo mb-45 mt-top2">
        <span style="margin-left:43%"><strong>Sales Return Copy</strong></span>
        <?php
        ...
        <!--                    <tr>
                ...
                <table class="table table-striped table-bordered responsive" id="add_quotation"  cellpadding="0" cellspacing="0">
                    ...
                    <tbody id='app_table'>
                        ...
                        $cgst = 0;
                        $sgst = 0;
                        $ret_qty = $total_qty = $sub_total = 0;
                        $net_value = 0;
                        if (isset($quotation_details) && !empty($quotation_details)) {
                            $inv = 0;
                            foreach ($quotation_details as $key => $vals) {

                                if ($vals['return_quantity'] > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text_right">
                                            <?php
                                            $qty = ($vals['invoice'][$key]['quantity'] - $vals['return_quantity']);
                                            echo number_format((($vals['return_quantity']) * $vals['per_cost']), 2);
                                            ?>
                                        </td>
                                        ...
                                        <td class="text_right" style="text-align:right;">
                                            <?php
                                            $presenet_qty = $vals['return_quantity'];
                                            $sub_total = $presenet_qty * $vals['per_cost'];
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="action-btn-align">Total</td>
                            <td class="action-btn-align"><?php echo $ret_qty; ?></td>
                            <td colspan="4" style="text-align:right;">Sub Total : </td>
                            <td class="text_right"><?php echo number_format($net_value, 2); ?></td>
                        </tr>
        <!--                        <tr>
                            <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
        ...
        <!--                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text_right bor-tb0" style="font-size:15px;"><?php echo number_format($net_value + $sgst + $cgst, 2); ?></td>
                ...
                <div class="hide_class action-btn-align">
                    <a href="<?php echo $this->config->item('base_url') . 'sales_return/invoice_view/' . $quotation[0]['id'] ?>"class="btn btn-defaultback"><span class="glyphicon"></span> Back </a>
