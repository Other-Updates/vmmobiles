                ...
                <table class="table table-striped table-bordered responsive" id="add_quotation"  cellpadding="0" cellspacing="0">
                    ...
                    <tbody id='app_table'>
                        ...
                        if (isset($quotation_details) && !empty($quotation_details)) {
                            foreach ($quotation_details as $vals) {
                                ...
                                $cgst1 = ($vals['tax'] / 100 ) * ($vals['per_cost'] * $vals['invoice'][0]['quantity']);

                                $gst_type = $quotation[0]['state_id'];
                                if ($gst_type != '') {
                                    if ($gst_type == 31) {

                                        $sgst1 = ($vals['gst'] / 100 ) * ($vals['per_cost'] * $vals['invoice'][0]['quantity']);
                                    } else {
                                        $sgst1 = ($vals['igst'] / 100 ) * ($vals['per_cost'] * $vals['invoice'][0]['quantity']);
                                    }
                                }
                                ...
                                <tr>
                                    ...
                                    <td class="action-btn-align">
                                        <?php echo $vals['invoice'][0]['quantity'];
                                        ?>
                                    </td>
                                    <td class="action-btn-align">
                                        <?php
                                    ...
                                    <td class="text_right">
                                        ...
                                        echo number_format(($vals['invoice'][0]['quantity'] * $vals['per_cost']), 2);
                                        ?>
                                    </td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align:right;" class="bor-tb0">Add CGST : </td>
                        ...
                        <tr>
                            ...
                            if ($gst_type != '') {
                                if ($gst_type == 31) {
                                    ?>
                                    <td colspan="5" style="text-align:right;" class="bor-tb0">Add SGST : </td>
                                <?php } else { ?>
                                    <td colspan="5" style="text-align:right;" class="bor-tb0">Add IGST : </td>
