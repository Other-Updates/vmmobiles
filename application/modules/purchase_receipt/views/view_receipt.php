...
<div class="mainpanel">
    <div class="media mt--40">
        <h4 class="hide_class">View Purchase Payment Receipt</h4>
    </div>
    ...
    <div class="contentpanel panel-body mb-45">
        <form method="post">
            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                ...
                <tr>
                    <td class="aleft"><span  class="tdhead">PO NO:</span></td>
                    <td><?php echo $receipt_details[0]['po_no'] ?></td>
                    <td class="action-btn-align"> <img src="<?= $theme_path; ?>/images/logo.png" alt="Chain Logo" width="125px"></td>
                    <td></td>
                </tr>
                <tr>
                    <td class="aleft"><span  class="tdhead">Date:</span></td>
                ...
                <tr>
                    <td class="aleft"><span  class="tdhead">Total Amount:</span></td>
                    <td><?php echo $over_all_net_total ?></td>
                    <td><span  class="tdhead">Total Received Amount:</span></td>
                    <td><?php echo number_format($paid, 2, '.', ',') ?></td>
                </tr>
                <tr>
                    <td class="aleft"><span  class="tdhead">Balance:</span></td>
                    <td><?php echo number_format($over_all_net_total - ($dis + $paid), 2, '.', ','); ?></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
        ...
        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
            ...
            <th class="action-btn-align">Receipt&nbsp;NO</th>
            <th class="action-btn-align">Received Date</th>
            ...
            <tbody id='receipt_info'>
                ...
                if (isset($receipt_details[0]['receipt_history']) && !empty($receipt_details[0]['receipt_history'])) {
                    ...
                    foreach ($receipt_details[0]['receipt_history'] as $val) {
                        ...
                        ?>
                        <tr>
                            <td class="action-btn-align"><?php echo $i ?></td>
                            <td class="action-btn-align"><?php echo $val['receipt_no'] ?></td>
                            ...
                            <td class="text_right"><?php echo number_format($val['discount'], 2, '.', ',') ?> ( <?php echo $val['discount_per'] ?> %)</td>
                            <td><?= $val['remarks'] ?></td>
                            <td class="hide_class">
        ...
        <div class="hide_class action-btn-align">
            <a href="<?php echo $this->config->item('base_url') ?>purchase_receipt/receipt_list" class="btn btn-defaultback"><span class="glyphicon"></span> Back </a>
