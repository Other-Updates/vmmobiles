...
<div class="mainpanel">
            <!--<div class="pageheader">
             ...
             <div class="media mt--40">
                 <h4 class="hide_class">View Project Cost              
              </h4>
             </div>
            <div class="contentpanel enquiryview  ptpb-10  viewquo mb-45 mt-top2">
                 ...
                 <?php       
                  ...
                  <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                   ...
                   <tr>
                     <td class="first_td1"><span  class="tdhead"> Reference Name:</span> </td>
                     <td> <?php  echo $val['nick_name']?></td>
                     <td class="first_td1"><span  class="tdhead">  Quotation NO:</span> </td>
                     <td> <?php echo $val['q_no'];?> </td>
                   </tr>  
                   <tr>
                     <td class="first_td1"><span  class="tdhead"> Job Id:</span></td>
