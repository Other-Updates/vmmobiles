...
<div class="mainpanel">
    ...
    <div class="contentpanel mb-25">
        ...
        if (isset($po) && !empty($po)) {
            foreach ($po as $val) {
                ?>
                <form  action="<?php echo $this->config->item('base_url'); ?>delivery_challan/update_dc/<?php echo $val['id']; ?>" method="post" class=" panel-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"  tabindex="1" name="po[dc_no]" class="code form-control colournamedup  form-align" readonly="readonly" value="<?php echo $val['dc_no']; ?>"  id="grn_no">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" tabindex="1" name="customer[store_name]" id="customer_name" class='form-align auto_customer required' value="<?php echo $val['store_name']; ?>" />
                                        <div class="input-group-addon">
                                            <i class="fa fa-bank"></i>
                                        </div>
                                    </div>
                                    <span class="error_msg"></span>
                                    <input type="hidden"  name="customer[id]" id="customer_id" class='form-control id_customer tabwid form-align' value="<?php echo $val['customer']; ?>" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text"  tabindex="1" name="customer[mobil_number]" id="customer_no" class="form-align required" value="<?php echo $val['mobil_number']; ?>"/>
                                        <div class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div id='customer_td'>
                                        <div class="input-group">
                                            <input type="text"  tabindex="1" name="customer[email_id]" id="email_id" class="form-align required"value="<?php echo $val['email_id']; ?>"/>
                                            <div class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" tabindex="1"  class="form-align datepicker required" name="po[created_date]" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($val['created_date'])); ?>" >
                                        <div class="input-group-addon">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" name="company[tin_no]" tabindex="1" class="form-align" value="<?php echo $val['tin'] ?>" />
                                        <div class="input-group-addon">
                                            <i class="fa fa-cog"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="customer[address1]" tabindex="1" id="address1" class="form-control form-align required"><?php echo $val['address1']; ?></textarea>
                                    <span class="error_msg"></span>
                                </div>
                            </div>
                        ...
                        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                            <thead>
                                <tr>
                                    ...
                                    <td width="32%" class="first_td1">Product Name</td>
                            ...
                            <tbody id='app_table'>
                                ...
                                if (isset($po_details) && !empty($po_details)) {
                                    foreach ($po_details as $vals) {
                                        ...
                                        <tr>
                                            <td>
                                                <select id='cat_id' class='cat_id static_style class_req required' name='categoty[]' style="width:100%">
                                            ...
                                            <td class="relative">
                                                <input type="text"  name="model_no[]" style="width:100%" id="model_no" class='form-align auto_customer tabwid model_no required form-control' value="<?php echo $vals['product_name']; ?>"/>
                                            ...
                                            <td>
                                                <input type="text"   tabindex="-1"  name='per_cost[]' style="width:70px;" class="percost required " value="<?php echo $vals['per_cost'] ?>"/>
                                                <span class="error_msg"></span>
                                            </td>
                                            <td>
                                                <input type="text"   tabindex="-1"   name='tax[]' style="width:70px;" class="pertax" value="<?php echo $vals['tax'] ?>" />                                        </td>
                                            <td>
                                                <input type="text"   tabindex="-1"   name='gst[]' style="width:70px;" class="gst" value="<?php echo $vals['gst'] ?>" />                                        </td>
                                            <td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="9" style="">
                                        ...
                                        <input type="hidden"  name="po[customer]" id="customer_id" class='id_customer' value="<?php echo $val['customer']; ?>"/>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
...
<script type="text/javascript">
    ...
    $('.del').on('click', function () {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo $this->config->item('base_url'); ?>" + "delivery_challan/delete_id",
            data: {del_id: del_id
            },
