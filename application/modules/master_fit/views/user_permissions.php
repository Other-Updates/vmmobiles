...
<div class="mainpanel">
    ...
    <div class="contentpanel mb-50">
        <div class="media mt--2">
            <h4>User Role Permissions (<?php echo $user_type[0]['user_role']; ?>)</h4>
        </div>
        <div class="panel-body">
            <?php echo form_open_multipart('master_fit/user_permissions/' . $user_role_id, 'name="user_permission" id="user_permission" class="form-horizontal"'); ?>
            <input type="hidden" name="user_type_id" id="user_type_id" value="<?php echo $user_role_id; ?>">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="button" class="btn btn-defaultback" onclick="window.location = '<?php echo base_url('master_fit'); ?>'" style="float:left;"><i class="icon-arrow-left13 position-left"></i> Cancel</button>
