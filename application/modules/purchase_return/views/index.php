        ...
        <form  method="post" class="panel-body">
            <table  class="table table-striped  responsive dataTable no-footer dtr-inline">
                <tr>
                    ...
                    <td> <input type="text"  tabindex="-1" name="po[po_no]" class="code form-control colournamedup  form-align" readonly="readonly" value="<?php echo $last_id[0]['value']; ?>"  id="grn_no"></td>
                    <td>Supplier Name</td>
                    <td>
                        <input type="text"  name="supplier[name]" id="customer_name" class='form-control form-align auto_customer required ' />
                        <span class="error_msg"></span>
...
<!--                              <input type="hidden"  name="po[product_id]" id="cust_id" class='id_customer' />-->
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"  name="supplier[mobil_number]" id="customer_no" class="form-control form-align required" />
                        <span class="error_msg"></span>
                    </td>
                    <td class="first_td1"  >Supplier Email ID</td>
                    <td id='customer_td'>
                        <input type="text"  name="supplier[email_id]" id="email_id" class="form-control form-align required"/>
                        <span class="error_msg"></span>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="supplier[address1]" id="address1" class="form-control form-align required"></textarea>
                        <span class="error_msg"></span>
                    </td>
            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                <thead>
                    <tr>
                        ...
                        <td  width="5%" class="first_td1">GST %</td>
