...
<div class="contentinner mb-100">
			...
			$filter = $this->session_view->get_session(null,null);
		 	$attributes = array('class' => 'stdform editprofileform','method'=>'post');
            	...
            	<h4 class="widgettitle">Allowance Reports</h4>
                <div class="well">
                ...
                <table class="table table-bordered print_border incentive_table"  style="font-size:10px;">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2"  rowspan="1">Allowances</th>
                        ...
                        <tr>
                            ...
                            <td class="center">
								...
								//print_r($allowance);
									...
									$new_val = explode('.',round($user_allowance,2));
									echo $new_val[0];
								?>
                            </td>
                            ...
                            <!--<td class="center"><?=$allowance[$k][0]["description"]?></td>-->                            
                            </tr>
                           <?php 
						   //exit;
						  }
