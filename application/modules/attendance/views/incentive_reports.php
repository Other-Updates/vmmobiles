...
<div class="contentinner mb-100">
			...
			$filter = $this->session_view->get_session(null,null);
		 	$attributes = array('class' => 'stdform editprofileform','method'=>'post');
            	...
            	<h4 class="widgettitle">Incentive Reports</h4>
                <div class="well">
                ...
                <table class="table table-bordered print_border incentive_table"  style="font-size:10px;">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2"  rowspan="1">Incentives</th>                                          
                        </tr>
                        <tr>
                            <th>Rs.</th>
                            <th>P.</th>                  
                            ...
                            <td class="center">
                             	<?php 
									...
									$new_val = explode('.',round($user_incentive,2));
									echo $new_val[0];
								?>
                             </td>
						 ...
						 if(empty($users))
						  {
						  	...
						  	echo "<tr><td colspan='4' class='center'>No Results Found</td></tr>";
						}?>
                   		</tbody>
                </table>
                </div>
