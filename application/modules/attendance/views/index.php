					...
					if(isset($users) && !empty($users))
					{
						...
						?>	
							<tr class="<?=$class?>">
                              ...
                              <?php
							  $v=0; 
							  if(in_array("attendance:view_attendance",$user_role)){
							  	 $url = $this->config->item('base_url')."attendance/view_attendance/".$user["id"];
							  if($class!="")
							     $url = $this->config->item('base_url')."attendance/view_attendance/".$user["id"]."?us=1";
							  ?>
                              <a title="View" href="<?=$url?>" class="btn btn-success btn-rounded"><i class="icon icon-eye-open"></i></a>
                              <?php 
							  $v=1;
							  }
							  ...
							  if($us =="active" && $class=="")
							  {
							  if(in_array("attendance:add_attendance",$user_role)){
							  ?>
                              <a  title="Add" href="<?=$this->config->item('base_url')."attendance/add_attendance/".$user["id"]?>" class="btn btn-danger btn-rounded">
