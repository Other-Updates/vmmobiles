...
<style type="text/css">
    .verticalTableHeader {text-align: center;transform: rotate(-90deg);/* position: absolute; *//* left: 78px; *//* height: 101px; *//* margin-bottom: 32px; *//* top: 105px; */width: 25px;/* white-space: nowrap; */margin-bottom: 5px;}
    .verticalTableHeader1 {text-align: center;transform: rotate(-90deg);/* position: absolute; *//* left: 78px; *//* height: 101px; *//* margin-bottom: 32px; *//* top: 105px; *//* white-space: nowrap; */margin-bottom: -1px; width: 10px; margin-left: 18px;}
    .verticalTableHeader2 {text-align: center;transform: rotate(-90deg);/* position: absolute; *//* left: 78px; *//* height: 101px; *//* margin-bottom: 32px; *//* top: 105px; *//* white-space: nowrap; */margin-bottom: -1px; width: 10px;}
    .verticalTableHeader3 {text-align: center;transform: rotate(-90deg);/* position: absolute; *//* left: 78px; *//* height: 101px; *//* margin-bottom: 32px; *//* top: 105px; *//* white-space: nowrap; */margin-bottom: -3px; width: 10px; margin-left:11px;}
    .verticalTableHeader4 {text-align: center;transform: rotate(-90deg);/* position: absolute; *//* left: 78px; *//* height: 101px; *//* margin-bottom: 32px; *//* top: 105px; *//* white-space: nowrap; */margin-bottom: -1px; width: 15px; margin-left:18px;}
...
<div class="contentpanel">
    ...
    <div class="panel-body mt-top5">
        ...
        <table class="table responsive_table table-bordered hide_class bottom">
...
//Setup a DatePeriod instance to iterate between the start and end date by the interval
    ...
    <div class="panel-body mt-top5">
<!--        <span class="hide_show hide_class">Show <select name="record_show" id="count_change">
...
<td>Name of the Company : <strong>FF Solutions</strong></td>

<td>Place : <strong>Anna Nagar</strong></td>

<td>District : <strong>COIMBATORE</strong></td>

<td>Holidays : <strong>Sunday , Saturday, PH-Public Holidays</strong></td>

<td colspan="4">Month of <strong>Nov 2018</strong></td>
        ...
        <div class="auto-scroll" id="remove_scroll_class">
            ...
            <table class="table table-bordered print_table2 print_border" style="font-size:9px;">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th rowspan="2"><div class="final_cl verticalTableHeader2">S.No&nbsp;</div></th>



                        <th rowspan="2"><div class="final_cl verticalTableHeader3">Employee&nbsp;ID&nbsp;</div></th>



                        <th rowspan="2"><div class="final_cl verticalTableHeader4">Emp&nbsp;Name&nbsp;</div></th>



                        <th rowspan="2"><div class="final_cl verticalTableHeader4">Department&nbsp;</div></th>



                        <th rowspan="2"><div class="final_cl verticalTableHeader3">Designation&nbsp;</div></th>
                        ...
                        <th rowspan="3" style="height:120px;text-align: -webkit-center;"><div class="final_cl verticalTableHeader">&nbsp;No.of&nbsp;working&nbsp;days&nbsp;
                            </div></th>

                        <th rowspan="3" style="height:120px;text-align: -webkit-center;"><div class="final_cl verticalTableHeader">&nbsp;Late&nbsp;MTD&nbsp;
                            </div></th>

                        <th rowspan="3" style="height:120px;text-align: -webkit-center;"><div class="final_cl verticalTableHeader">&nbsp;EarlyGoing&nbsp;MTD&nbsp;
                            </div></th>

                        <th  rowspan="3" class="hide_class" style="text-align:center;" ><div class="final_cl verticalTableHeader1">Detailed&nbsp;Report&nbsp;</div></th>
                        ...
                        foreach ($monthly_reports as $key => $report_data) {
                            ...
                            <tr>
                                ...
                                foreach ($report_data['monthly_works'] as $key1 => $over_data) {
                                    ...
                                    if ($over_data['month_attenance'] == "P")
                                        $present +=1;
                                    elseif ($over_data['month_attenance'] == "1/2A")
                                        $present +=0.5;
                                    elseif ($over_data['month_attenance'] == "1/4A")
                                        $present +=0.75;
                                    elseif ($over_data['month_attenance'] == "3/4A")
                                        $present +=0.25;
                                    ?>

                                    <td><?php echo $over_data['month_attenance']; ?></td>
                                ...
                                <td class="text-center hide_class">
                                    ...
                                    echo "<span class='badge bg-green view_monthly_report' emp_id='$employee_id' style='cursor: pointer;' href='$link'>View</span>";
                                    ?>
                                </td>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.view_monthly_report', function () {
        ...
        $.ajax({
            ...
            {
                window.location = '<?php echo $this->config->item('base_url') . 'attendance/reports/monthly_attendance_view/'; ?>' + emp_id;
            }
        });
    });
