...
<!--                <tr>
                    ...
                    <td>
                        ...
                        <select class="select_agent" style="display: none;width:170px;" name="receipt_bill[recevier_id]">
                ...
                <tr>  
                    <td colspan='3' style='text-align: right;'>Payment Terms</td><td  style='align: right;'>
                        <select class='form-control' id='terms1' style="width:170px; display:none;" name='receipt_bill[terms]'>
                            <option class="1" value='1'>CASH</option>                                            
                        </select>

                        <select class='form-control' id='terms' style="width:170px;" name='receipt_bill[terms]'>
                            <option class="1" value='1'>CASH</option>
                ...
                <tr class='show_tr' style='display:none'>
                    ...
                    <td  style='align: right;'>
                        <input id='ac_no'  class='form-control'  style=' width:170px ;float:left;' type='text'  name='receipt_bill[ac_no]' />
                ...
                <tr class='show_tr' style='display:none'>
                    ...
                    <td  style='align: right;'>
                        <input id='branch'  class='form-control'  style=' width:170px ;float:left;' type='text'  name='receipt_bill[branch]' />
                ...
                <tr  class='show_tr' style='display:none'>
                    ...
                    <td  style='align: right;'>
                        <input id='dd_no'  class='form-control dduplication' style=' width:170px ;float:left;' type='text'  name='receipt_bill[dd_no]' /><br /><br />
                ...
                <tr>
                    <td colspan="3" style="text-align:right;"><span style='  position: relative; top: 10px;'>Discount</span> 
                        <input id='discount_per' autocomplete='off'  class='form-control' style=' width:170px;float:right;' type='text'  name='receipt_bill[discount_per]' />
                    </td>
                    <td>
                        <input id='discount'  class='form-control dot_val' style=' width:170px ;float:left;' type='text'  name='receipt_bill[discount]' />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Paid Amount</td>
                    <td>
                        <input id='paid'  class='form-control dot_val' type='text'  style=' width:170px ;float:left;'  name='receipt_bill[bill_amount]'  />
                        <br /><br /><p id="receiptuperror3" style="color:#F00;" ></p> </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Due Date</td>
                    <td>
                        <input type='text'  style=' width:170px ;float:left;'  class="datepicker" name='receipt_bill[due_date]'  />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Created Date</td>
                    <td>
                        <input type='text'  id='c_date' style=' width:170px ;float:left;'  class="datepicker" name='receipt_bill[created_date]'  />
                        <br /><br /><p id="date_err" style="color:#F00;" ></p>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Balance</td>
                    <td>
                        <input id='balance'  class='form-control' type='text'  style=' width:170px ;float:left;'  name='balance'   value='<?php echo ($receipt_details[0]['net_total'] - $dis) - $paid; ?>'  readonly='readonly' />
                    </td>
                </tr>

                <tr><td class="action-btn-align"  colspan="4"> <input  type="submit" class="btn btn-success" value="Pay" id="pay"/> </td></tr>
